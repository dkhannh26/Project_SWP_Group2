...
public class staffURL {
    ...
    public static final String URL_UPDATE_PRODUCT_STAFF = "/staff/product/update";
    ...
    public static final String URL_CUSTOMER_DELETE_STAFF = "/staff/account/delete-customer";
