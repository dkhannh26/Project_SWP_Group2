        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <c:forEach items="${listProduct}" var="product">
                    ...
                    <h5 class="info-content"><b>ACCOUNT INFORMATION</b></h6>
                        <div class="user-info">
                            <div class="flex user-name">
                                <h6 class="highlight">Nguyễn Chí Nguyên</h6>
                                <div class="dropdown">
                            ...
                            <div class="dropdown-container">
                                <div class="input-group"> 
                                    ...
                                    <input class="text-field" type="text" value="Nguyễn Chí Nguyên">
                                </div>
                                <div class="input-group"> 
                                    <span class="input-icon">
                                        <i class="fa-solid fa-house"></i>
                                    </span>
                                    <input class="text-field" type="text" value="Khu dân cư 5A">
                                </div>
                                <div class="input-group"> 
                                    <span class="input-icon">
                                        <i class="fa-regular fa-envelope"></i>
                                    </span>
                                    <input class="text-field" type="text" value="nguyenchinguyenstfc2018@gmail.com">
                                </div>
                                <div class="input-group"> 
                                    <span class="input-icon">
                                        <i class="fa-solid fa-phone"></i>
                                    </span>
                                    <input class="text-field" type="text" value="0985425785">
                                </div>
                            ...
                            <ul class="info">
                                <li><span class="highlight">Email:</span> nguyenchinguyenstfc2018@gmail.com</li>
                                <li><span class="highlight">Country:</span> Vietnam</li>
                                <li><span class="highlight">Address:</span> wenfjwnfjnwejfn</li>
                            </ul>
                        </div>
