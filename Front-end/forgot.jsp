        ...
        <div id="wrapper">
            <form action="http://localhost:8080/Project_SWP_Group2/login/forgot" method="POST">
                <div class="bao">
                    ...
                    <button class="Restore btn-send" onclick="checkMail()" id="resetButton">Reset</button>
                    <div class="other-options">
                        <p>Did you remember your password? <a href="" class="highlight2">Back to Log In </a></p>
